...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            if (mIconGravity == Gravity.LEFT) {
                ...
                tabView = LayoutInflater.from(mContext).inflate(R.layout.flyco_custom_layout, this, false);
    ...
    private void addTab(final int position, View tabView) {
        ...
        LottieAnimationView iv_tab_icon = tabView.findViewById(R.id.iv_tab_icon);
        iv_tab_icon.setAnimation(mTabEntitys.get(position).getTabUnselectedIcon());
...
//            tv_tab_title.setPadding((int) mTabPadding, 0, (int) mTabPadding, 0);
            ...
            if (mIconVisible) {
                ...
                iv_tab_icon.setAnimation(i == mCurrentTab ? tabEntity.getTabUnselectedIcon() : tabEntity.getTabSelectedIcon());
                iv_tab_icon.reverseAnimationSpeed();
    ...
    private void updateTabSelection(int position) {
        ...
        for (int i = 0; i < mTabCount; ++i) {
            ...
            CustomTabEntity tabEntity = mTabEntitys.get(i);
            if (isSelect) {
                iv_tab_icon.setProgress(0);
                iv_tab_icon.reverseAnimationSpeed();
                iv_tab_icon.playAnimation();
            }
        ...
        View tabView = mTabsContainer.getChildAt(mLastTab);
        LottieAnimationView iv_tab_icon = tabView.findViewById(R.id.iv_tab_icon);
        CustomTabEntity tabEntity = mTabEntitys.get(mLastTab);
        iv_tab_icon.setProgress(0);
        iv_tab_icon.reverseAnimationSpeed();
        iv_tab_icon.playAnimation();
    }
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public LottieAnimationView getIconView(int tab) {
